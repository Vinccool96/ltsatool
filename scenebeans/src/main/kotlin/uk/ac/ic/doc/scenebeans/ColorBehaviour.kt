...
/**
 * A behaviour that encapsulates a changing [java.awt.Color] value.
 */
interface ColorBehaviour {
    /**
     ...
     */
    fun addColorBehaviourListener(l: ColorBehaviourListener)
     ...
     */
    fun removeColorBehaviourListener(l: ColorBehaviourListener)
}