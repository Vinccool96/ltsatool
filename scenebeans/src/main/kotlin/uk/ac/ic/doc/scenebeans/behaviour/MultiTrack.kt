...
/**
 * The [MultiTrack](../../../../../../../beans/multitrack.html)
 * behaviour bean.
 */
class MultiTrack : PointActivityBase(), Serializable {
    private var _nodes: DoubleArray
    private var _events: Array<String?>
    private var _timeout = 0.0
    private var _current = 0
    var spacing = 0.0
    var avoid: Point2D = Point2D.Double(0.0, 0.0)

    init {
        _nodes = DoubleArray(0)
        _events = arrayOfNulls(0)
        avoid = Point2D.Double(100000.0, 100000.0)
    }
    ...
    private val isCollision: Boolean
        ...
        private get() = avoid.distanceSq(value) < spacing * spacing

    fun newAvoidAdapter(): AvoidAdapter {
        return AvoidAdapter()
    }
