...
/**
 * A behaviour that encapsulates a changing [String] value.
 */
interface StringBehaviour {
    /**
     ...
     */
    fun addStringBehaviourListener(l: StringBehaviourListener)
     ...
     */
    fun removeStringBehaviourListener(l: StringBehaviourListener)
}